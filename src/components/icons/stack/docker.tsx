...
export const DockerIcon = ({ height = 64, width = 64, title = 'Docker' }: IconProps) => {
  return (
    <svg height={height} viewBox="0 0 128 128" width={width}>
      ...
      <g>
        ...
        <path
          ...
          fill="#BFDBE0"
        />
        <path d="M46.1 89.9c-.9-1.3-1.8-2.8-2.5-4.3-2.5.7-5.5 1.2-8.9 1.4 2.3 1.2 5.7 2.4 11.4 2.9z" fill="#D4EEF1" />
      </g>
    </svg>
  );
};
